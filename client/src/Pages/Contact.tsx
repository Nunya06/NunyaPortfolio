          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-700 hover:bg-orange-800 text-white py-3 rounded-lg font-medium transition-colors"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">wisdomxorse928@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-neutral-900 p-3 rounded-lg border border-neutral-800">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">+233 (0) 545-327-593</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-neutral-900 p-3 rounded-lg border border-neutral-800">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Burma Camp, Ghana</p>
                  </div>
                </div>
              </div>
